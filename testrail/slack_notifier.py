...
"""
This module provides functionalities for sending notifications to Slack channels, specifically 
designed for use in automated testing and release processes. It includes capabilities for 
sending both success and error notifications with customizable message templates. 
The module leverages Taskcluster for notification services and integrates with Slack's API to deliver real-time updates.
...
notifications are required to report the status of various processes, such as test executions or release milestones.
...
SLACK_SUCCESS_MESSAGE_TEMPLATE_IOS = Template(
    """
[
    {
        "type": "header",
